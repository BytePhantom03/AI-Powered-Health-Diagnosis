...
def get_predicted_value(patient_symptoms):
    ...
    for item in patient_symptoms:
        ...
        if clean_item in symptoms_dict:
            ...
            print(f"Unknown symptom: {item}")  # Optional logging
...
def home():
    if request.method == 'POST':
        ...
        if not valid_symptoms:
            return render_template('index.html', message="⚠️ None of the symptoms matched our database. Please recheck spelling.")
